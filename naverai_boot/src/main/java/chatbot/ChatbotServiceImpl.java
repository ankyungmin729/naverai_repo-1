...
public class ChatbotServiceImpl implements NaverService {
	...
	public String test(String question) {
		return test(question, "send");
	}
	
	public String test(String question, String event) {
		// String result = main(question, MyNaverInform.chatbot_apiURL, MyNaverInform.chatbot_secret);
		// System.out.println("=========챗볼 결과==========");
		// System.out.println(result);
		String chatbotMessage = "";
		try {
			String apiURL = MyNaverInform.chatbot_apiURL;
			URL url = new URL(apiURL);
			String message = getReqMessage(question, event); // json으로 변경
